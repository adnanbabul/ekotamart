                          ...
                          <tr>
                                ...
                                <td>
                                    @if ($item->brand_image == '' || $item->brand_image == null)
                                        <img loading="lazy" src="{{ asset('no_image.jpg') }}" style="height: 50px; width:70px;" alt="No Image">
                                    @else
                                        <img loading="lazy" src="{{ asset('storage/brand/' . $item->brand_image) }}" style="height: 50px; width:70px;">
                                    @endif
                                </td>
