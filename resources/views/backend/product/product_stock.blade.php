                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->product_thambnail == '' || $item->product_thambnail == null)
                                                        <img loading="lazy" src="{{ asset('upload/no_image.jpg') }}"
                                                            style="height: 50px; width:70px;" alt="No Image">
                                                    @else
                                                        <img loading="lazy"
                                                ...
                                                @if ($item->product_qty > 0)
                                                    <td class="text-center">
                                                        <p id="product_qty_{{ $item->id }}">{{ $item->product_qty }}</p>
                                                ...
                                                <td>
                                                    <a href="#" id="{{ $item->id }}"
                                                        onclick="stock_qty(this.id,{{ $item->product_qty }})"
                                                        class="btn btn-info btn-sm" data-toggle="modal"
                                                        data-target="#StockUpdate" title="Stock Edit"><i
