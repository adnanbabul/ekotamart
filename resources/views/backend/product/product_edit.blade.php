...
@section('admin')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 1st row -->
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">Category<span class="text-danger">*</span>
                                                        </h5>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">SubCategory<span class="text-danger"></span>
                                                        </h5>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">SubSubCategory<span
                                                        ...
                                                        <select name="author_id" class="form-control">
                                                            ...
                                                            @foreach ($authors as $author)
                                                                <option value="{{ $author->id }}"
                                                                    {{ $author->id == $products->author_id ? 'selected' : '' }}>
                                                                    {{ $author->author_name_en }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('author_id')
                                                            <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">Book-Type<span class="text-danger"></span>
                                                        </h5>
                                                        <select name="book_type_id" class="form-control">
                                                            <option value="" selected>Select</option>
                                                            @foreach ($book_types as $book_type)
                                                                <option value="{{ $book_type->id }}"
                                                                    {{ $book_type->id == $products->book_type_id ? 'selected' : '' }}>
                                                                    {{ $book_type->book_type_name_en }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('book_type_id')
                                                            <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">Publication<span class="text-danger"></span>
                                                        </h5>
                                                        <select name="publication_id" class="form-control">
                                                            <option value="" selected>Select</option>
                                                            @foreach ($publications as $publication)
                                                                <option value="{{ $publication->id }}"
                                                                    {{ $publication->id == $products->publication_id ? 'selected' : '' }}>
                                                                    {{ $publication->publication_name_en }}</option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="row"> <!-- start 2nd row -->
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <h5 class="head-text">Product Name En <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <h5 class="head-text">Product Name Bn <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_name_bn"
                                                            value="{{ $products->product_name_bn }}" class="form-control"
                                                            required="">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <h5 class="head-text">Product Units<span
                                                                class="text-danger"></span></h5>
                                                        <select name="product_units_id" class="form-control">
                                                            <option value="" selected>Select</option>
                                                            @foreach ($product_units as $product_unit)
                                                                <option value="{{ $product_unit->id }}"
                                                                    {{ $product_unit->id == $products->product_units_id ? 'selected' : '' }}>
                                                                    {{ $product_unit->product_units_name_en }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('product_units_id')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <h5 class="head-text">Product Code <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 6th row -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text text-danger"><del>Selling Price</del> <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text text-success">Discount Price <span
                                                            class="text-danger"></span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 7th row -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text">Short Description English <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text">Short Description Bangla <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 8th row -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text">Long Description English <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5 class="head-text">Long Description Bangla <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <span class="text-danger">
                                            <p><strong>Special Section Select</strong></p>
                                        </span>
                                        ...
                                        <span class="text-danger">
                                            <p><strong>Sidebar Top Section Select</strong></p>
                                        </span>
                                            ...
                                            @foreach ($top_sidebar as $key => $item)
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <fieldset>
                                                                <input type="radio" name="sid_sps_section"
                                                                    id="{{ $key + 1 }}"
                                                                    value="{{ $item->name_en }}"
                                                                    {{ strtolower($item->name_en) == $products->sid_sps_section ? 'checked' : '' }}
                                                                    onchange="dateShow('{{ $item->name_en }}', 'show_date{{ $key + 1 }}')">
                                                                <label
                                                                    for="{{ $key + 1 }}">{{ $item->name_en }}</label>
                                                            </fieldset>

                                                            @if (
                                                                $item->name_en == 'medicin' ||
                                                                    $item->name_en == 'Medicin' ||
                                                                    $item->name_en == 'medicine' ||
                                                                    $item->name_en == 'Medicine' ||
                                                                    $item->name_en == 'medicined' ||
                                                                    $item->name_en == 'Medicined' ||
                                                                    $item->name_en == 'pharmacy' ||
                                                                    $item->name_en == 'Pharmacy' ||
                                                                    $item->name_en == 'pharmacys' ||
                                                                    $item->name_en == 'Pharmacys' ||
                                                                    $item->name_en == 'Pharmecy' ||
                                                                    $item->name_en == 'pharmecy')
                                                                <div id="show_date{{ $key + 1 }}" id="div_input"
                                                                    class="controls div_hide col-md-5">
            ...
            <div class="row text-center">
                <div class="col-md-4 container">
                    <div class="box bt-3 border-info">
                        ...
                        <form method="post" action="{{ route('update-product-thambnail', $products->id) }}"
                            ...
                            <div class="row row-sm">
                                <div class="col-md-3">
                                    <div class="card container" style="width: 22rem;">
                                        <img loading="lazy"
                                            src="{{ asset('storage/products/thambnail/' . $products->product_thambnail) }}"
                                            class="card-img-top" style="height: 250px; width:400px;">
                                        <div class="card-body">
                                            <p class="card-text">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 mt-5">
                                                    <img loading="lazy" id="show_image" style="width:50px; height:50px;"
                                                        src="{{ !empty($products->product_thambnail)
                                                            ? asset('storage/products/thambnail', $products->product_thambnail)
                            ...
                            <div class="text-xs-right">
                                <input type="submit" class="btn btn-rounded btn-info float-left mb-5 mt-5"
                                    value="Update Image">
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-4  show_image_pojition">
                                        <img loading="lazy" id="show_multi_img_add" style="width:100px; height:100px;"
                                            src="{{ !empty($product_multi_img->photo_name)
                                                ? asset('storage/products/multi-image/' . $product_multi_img->photo_name)
                                                : url('upload/no_image.jpg') }}"
                                            alt="Brand Image">
                                    </div>
                                    ...
                                    <div class="col-md-4 add_image_pojition">
                                        <div class="float-right">
                                            <form method="post" action="{{ route('add-product-image') }}"
                                                enctype="multipart/form-data" id="form-submit">
                                                @csrf
                                                <div class="form-group">
                                                    <input type="hidden" name="product_id" value="{{ $products->id }}">
                                                    <label for="multi_img_add"
                                                        class="form-control-label text-white">Multi-Img Add</label>
                                                    <input type="file" name="multi_img_add" id="multi_img_add"
                                                        class="form-control form-control-sm" placeholder="MultiImgAdd"
                                                        style="width: 110px;">
                                                    <span style="background-color: aliceblue; color:#08c708;"
                                                        class="text-danger" id="msg_v_add">
                                                        @error('multi_img_add')
                                                            {{ $message }}
                                                        @enderror
                                                    </span><br>

                                                    <input id="one_add_multi_img" type="submit"
                                                        class="btn btn-rounded btn-info btn-sm float-left"
                                                        onclick="disableInput()" value="Add">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                @foreach ($multiImgs as $key => $img)
                                    <div class="col-md-3">
                                        <div class="card" style="width: 14rem;">
                                            <img loading="lazy"
                                                src="{{ asset('storage/products/multi-image/' . $img->photo_name) }}"
                                                class="card-img-top" style="height: 130px; width:280px;">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <a href="{{ route('product.multiimg.delete', $img->id) }}"
                                                        class="btn btn-sm btn-danger delete_data" title="Delete Data"><i
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control"
                                                        ...
                                                        id="upload_file_multiImg_{{ $key }}">
                                                </div>
                                                <span class="text-danger" id="msg_v_multiImg_{{ $key }}">
                                                    @error('multi_img')
                                                        {{ $message }}
                                                    @enderror </span>
                                    ...
                                    @push('js')
                                        <script>
                                            multi_image_validation("#upload_file_multiImg_{{ $key }}", "#show_image_multiImg_{{ $key }}",
                                                "#msg_v_multiImg_{{ $key }}", '500', "Product size can't larger than 500 kb")
                                        </script>
                                    @endpush
                                @endforeach
                            </div>
    ...
    @push('js')
        ...
        <script>
            image_validation("#multi_img_add", "#show_multi_img_add", "#msg_v_add", '1024',
                "Photo brand size can't larger than 1 MB")
        </script>
        ...
        <script>
            function dateShow(value, div_id) {
                ...
                if (value == 'medicin' || value == 'Medicin' || value == 'medicine' || value == 'Medicine' || value ==
                    'medicined' || value == 'Medicined' || value == 'medicines' || value == 'Medicines' || value ==
                    'pharmacy' || value == 'Pharmacy' || value == 'pharmacys' || value == 'Pharmacys' || value == 'Pharmecy' ||
                    value == 'pharmecy') {
                    $("#" + div_id).show();
                    $("#div_input").show();
                } else if (value != 'medicin' || value != 'Medicin' || value != 'medicine' || value != 'Medicine' || value !=
                    'medicined' || value != 'Medicined' || value != 'medicines' || value != 'Medicines' || value !=
                    'pharmacy' || value != 'Pharmacy' || value != 'pharmacys' || value != 'Pharmacys' || value != 'Pharmecy' ||
                    value != 'pharmecy') {
                    $(".div_hide").hide();
                                ...
                                fRead.onload = (function(file) {
                                    return function(e) {
                                        var img = $('<img/>').addClass('thumb').attr('src',
                                            e.target.result).width(80).height(80);
