    ...
    <div class="card text-center m-2">
        <div class="card-header" style="background: #8f00ff;">
            <a href="{{ route('productPage.special') }}" style="text-decoration: none;">
                <h1 style="font-family: 'Pacifico'; color:aliceblue;">
                    {{ session()->get('language') == 'bangla' ? 'স্পেশাল অফার' : 'Special Offer' }} </h1>
            </a>
        </div>
        <div class="card-body">
                    ...
                    <div class="card-wrapper swiper-wrapper">
                        @foreach ($special_offer as $hot)
                            <div class="card swiper-slide">
                                <a href="{{ route('product.special', ['product_id' => $hot->id]) }}"
                                    style="text-decoration: none;">
                                    <div class="image-content">
                                        <span class="overlay"></span>
                                        <div class="card-image">
                                            {{-- <img src="{{ URL::to('storage/products/thambnail', $hot->product_thambnail) }}" alt="" class="card-img" loading="lazy"> --}}
                                            <img src="{{ asset('storage/products/thambnail/' . $hot->product_thambnail) }}"
                                                alt="" class="card-img" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="card-content">
                                        <h2 class="name">
                                            {{ session()->get('language') == 'bangla' ? Illuminate\Support\Str::limit($hot->product_name_bn, 15) : Illuminate\Support\Str::limit($hot->product_name_en, 15) }}
                                        </h2>
                                        <p class="description">
                                            @if (isset($hot->discount_price))
                                                <div class="row">
                                                    <div class="col-6 d-flex justify-content-end">
                                                        <span style="color: red;">৳&nbsp;{{ $hot->discount_price }}
                                                        </span>
                                                    </div>
                                                    <div class="col-6 d-flex justify-content-start">
                                                        <span
                                                            style="text-decoration: line-through;">৳&nbsp;{{ $hot->selling_price }}
                                                        </span>
                                                    </div>
                                                </div>
                                            @else
                                        ...
                                        <p class="description">
                                            <span style="color:crimson;font-size: 12px; font-weight: bold;">
                                                {{ $hot->product_qty > 10 ? 'Stock available' : 'Stock Limited' }}</span>
                                        </p>
            ...
            <div class="card text-dark bg-light mb-3" style="max-width: 100%">
                <div class="card-header" style="background: #B284BE;">
                    <a href="{{ route('productPage.special.deal') }}" style="text-decoration: none;">
                        <h1 style="font-family: 'Pacifico'; color:aliceblue;">
                            {{ session()->get('language') == 'bangla' ? 'স্পেশাল ডিল' : 'Special Deal' }} </h1>
                    </a>
                </div>
                <div class="card-body">
                        ...
                        @foreach ($special_deals as $hot)
                            ...
                            <div style="margin : 10px;  display: inline-block;">
                                <div class="card customcard" style=" position: initial;">
                                    <a href="{{ route('product.special.deal', ['product_id' => $hot->id]) }}"
                                        style="text-decoration: none;">
                                        <div class="card-body" style="max-width: 100px;">
                                            ...
                                            <h5 class="card-title"
                                                style="text-align:center;white-space:break-spaces; min-height:20px;">
                                                {{ session()->get('language') == 'bangla' ? Illuminate\Support\Str::limit($hot->product_name_bn, 15) : Illuminate\Support\Str::limit($hot->product_name_en, 15) }}
                                            </h5>
                                            <p class="description">
                                                <span style="color:crimson;font-size: 10px; font-weight: bold;">
                                                    {{ $hot->product_qty > 10 ? 'Stock available' : 'Stock Limited' }}</span>
                                            </p>
            ...
            <div class="card text-dark bg-light mb-3">
                <div class="card-header" style="background:#F34486;">
                    <a href="{{ route('productPage.featured') }}" style="text-decoration: none;">
                        <h1 style="font-family: 'Pacifico'; color:aliceblue;">
                            {{ session()->get('language') == 'bangla' ? 'ফিচারড' : 'Featured' }}</h1>
                </div>
                <div class="card-body">
                    <!-- <div class="row" style=" border: 1px solid #eee; margin : -8px"> -->
                    <div style=" border: 1px solid #eee; margin : -8px;  overflow: auto;white-space: nowrap;">
                        @foreach ($featured as $hot)
                            ...
                            <div style="margin : 10px;  display: inline-block;">
                                <div class="card customcard" style=" position: initial;">
                                    <a href="{{ route('product.featured', ['product_id' => $hot->id]) }}"
                                        style="text-decoration: none;">
                                        <div class="card-body" style="max-width: 100px;">
                                            <img src="{{ asset('storage/products/thambnail/' . $hot->product_thambnail) }}"
                                                alt="" style="text-align:center; margin: auto;display: block;"
                                                loading="lazy">
                                            {{-- <img src="{{ URL::to('storage/products/thambnail', $hot->product_thambnail) }}"
                                                alt="" style="text-align:center; margin: auto;display: block;"
                                                loading="lazy"> --}}
                                            <a href="{{ url('product/details/' . $hot->id) }}"></a>
                                            <h5 class="card-title"
                                            ...
                                            <p class="description">
                                                <span style="color:crimson;font-size: 10px; font-weight: bold;">
                                                    {{ $hot->product_qty > 10 ? 'Stock available' : 'Stock Limited' }}
                                                </span>
                                            </p>
    ...
    <div class="card text-center  m-2">
        <div class="card-header" style="background:#6C9BCF;">
            <a href="{{ route('productPage.hotdeal') }}" style="text-decoration: none;">
                <h1 style="font-family: 'Pacifico'; color:aliceblue;"><i class="fa-solid fa-fire fa-shake"
                        style="color: #fa7000;"></i>{{ session()->get('language') == 'bangla' ? 'হট ডিল' : 'Hot Deal' }}
                    <i class="fa-solid fa-fire fa-shake" style="color: #fa7000;"></i>
                </h1>
            </a>
        </div>
        <div class="card-body">
            ...
            <div style=" border: 1px solid #eee; margin : -8px;  overflow: auto;white-space: nowrap;">
                @foreach ($hot_deal as $hot)
                    <!-- <div class="col-md" style="margin : 10px"> -->
                    <div style="margin : 10px; display: inline-block;">
                        <a href="{{ route('product.hotdeal', ['product_id' => $hot->id]) }}"
                            style="text-decoration: none;">
                            <div class="card customcard" style=" position: initial;">
                                <div class="card-body" style="max-width: 100px;">
                                    <img src="{{ asset('storage/products/thambnail/' . $hot->product_thambnail) }}"
...
@php
    $color = ['#FC4F00', '#643A6B', '#4C4C6D', '#E76161', '#19A7CE', '#B71375', '#394867', '#0A4D68'];
    $k = 0;
@endphp
...
@if ($category_wise_product != ' ')
    ...
    @foreach ($category_wise_product as $category_product)
     ...
     {{ $color[rand(0, 7)] }}
     '>
                        <a href="{{ route('productPage.category', ['mainCategory_id' => $category_product[0]->category->id, 'mainCategory_name' => $category_product[0]->category->category_name_en]) }}"
                            style="text-decoration: none;">
                            <h1 style="font-family: 'Pacifico'; color:aliceblue;"> <img
                                    src="{{ asset('storage/category_icon/' . $category_product[0]->category->category_icon) }}"
                                    alt="" width="40px" height="40px" loading="lazy">
                                {{ session()->get('language') == 'bangla' ? $category_product[0]->category->category_name_bn : $category_product[0]->category->category_name_en }}
                                <img src="{{ asset('storage/category_icon/' . $category_product[0]->category->category_icon) }}"
                                    alt="" width="40px" height="40px" loading="lazy">
                            </h1>
                        </a>
                    </div>
                            ...
                            @foreach ($category_product as $hot)
                                ...
                                <div style="margin : 10px;  display: inline-block;">
                                    <a href="#" style="text-decoration: none;">
                                        <div class="card " style="width: 200px; position: initial;">
                                            <div class="card-body">
                                                <img src="{{ URL::to('storage/products/thambnail', $hot->product_thambnail) }}"
                                                    alt=""
                                                ...
                                                @if (isset($hot->discount_price))
                                                    <div class="row">
                                                        <div class="col-6 d-flex justify-content-end">
                                                            <span
                                                                style="color: red;">৳&nbsp;{{ $hot->discount_price }}
                                                            </span>
                                                        </div>
                                                        <div class="col-6 d-flex justify-content-start">
                                                            <span
                                                ...
                                                <div class="btn-group cart_group" style="display: flex;">
                                                    <button class="btn btn-danger cart_button" type="button"
                                                        title="Wishlist" id="{{ $hot->id }}"
                                                    ...
                                                    @foreach ($carts as $key => $value)
                                                        @if ($value->name == $hot->product_name_en && $value->qty > 0)
                                                            <div id="{{ $hot->id }}"
                                                                class="btn-group cart_group"
                                                                style="display: flex; display:contents">
                                                                <button type="submit"
                                                                    class="btn btn-warning btn-sm cart_decrease"
                                                                    id="{{ $value->rowId }}"
                                                                ...
                                                                <input type="text" value="{{ $value->qty }}"
                                                                    ...
                                                                    style="width:25px;">
                                                                <button type="submit"
                                                                    class="btn btn-success btn-sm cart_increase"
                                                                    id="{{ $value->rowId }}"
                                                ...
                                                @if ($flag == 'NotFound')
                                                    <div id="{{ $hot->id }}" class="btn-group cart_group"
                                                        style="display: flex; display:contents">
                                                        <button type="button" class="btn btn-danger add_cart"
                                                            title="Add Cart" id="{{ $hot->id }}"
                                                            onclick="add_product_to_cart(this.id)"
                                                ...
                                                <div class="btn-group cart_group"
                                                    style="display: flex; display:none"></div>
                                                <button class="btn btn-danger cart_button"
                                                    id="{{ $hot->id }}" data-bs-toggle="modal"
                                                    data-bs-target="#pdoductDetailModal"
                                                    onclick="show_product_detail(this.id)"><i
    ...
    ">`
                $.each(response.sliders, function(key, value) {
                    frontSlider += `<div class="image_slide` +
                        ...
                        +
                        `<a href="/category/${value.category_id}/category"><img src="/storage/slider/${value.slider_img}" alt=""></a>`
