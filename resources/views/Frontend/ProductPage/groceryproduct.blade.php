...
<div class="content_one" id="frontSlider" style="margin-top: 50px;">
</div>
<div class="content_one" style="min-height: 1000px; padding-top: 30px;">
    <div class="container">
        <div style="display: flex;"> <a href="{{ url('/') }}" style="text-decoration: none; ">
            ...
            <h1>/ {{ session()->get('language') == 'bangla' ? 'গ্রোসারি' : 'Grocery' }}
            </h1>
        </div>
        @if (isset($product))
                                    ...
                                    @if ($value->name == $product->product_name_en && $value->qty > 0)
                                        <div id="{{ $product->id }}" class="btn-group cart_group"
                                            ...
                                            <input type="text" value="{{ $value->qty }}" min="1"
                                                max="100" disabled="" style="width:25px;">
...
<script type="text/javascript">
    function ShowSlider() {
        $.ajax({
            type: 'GET',
            url: '/slider/grocery/show/grocery',
            dataType: 'json',
            success: function(response) {
                ...
                $.each(response.sliders, function(key, value) {
                    frontSlider += `<div class="image_slide` +
                        ...
                        +
                        `<img src="/storage/top_sidebar_menu_wise_slider/${value.top_sidebar_menu_slider_img}" alt="">`
