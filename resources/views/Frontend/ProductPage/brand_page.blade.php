...
<div class="content_one" style="min-height: 1000px;">
    <div class="container">
        <div style="display: flex; margin-top:50px;"> <a href="{{ url('/') }}" style="text-decoration: none; ">
                @if (session()->get('language') == 'bangla')
                    <h1>প্রচ্ছদ</h1>
                @else
                    <h1>Home</h1>
        ...
        <div class="row" style=" border: 1px solid #eee; margin-top: 25px">
            @foreach ($brands as $brand)
                ...
                <a href="{{ route('productPage.single.brand', $brand->id) }}"
                    style="position: initial;max-width: 250px;text-decoration: none;padding:10px">
                    <div class="card" style="position: initial;">
                        <div class="card-body" style="min-height: 300px;min-width:200px">
                            <img src="{{ asset('storage/brand/' . $brand->brand_image) }}" alt=""
                                style="text-align:center;width: 100%; height: 100%; margin: auto;display: block;"
                                loading="lazy">

                            <h5 class="card-title" style="min-height:50px; text-align:center;">
