...
<div class="content_one" style="min-height: 1000px;">
    <div class="container">
        <div style="display: flex; margin-top:50px;"> <a href="{{ url('/') }}" style="text-decoration: none; ">
            ...
            <h1>/</h1>
            <a href="{{ route('productPage.brand') }}" style="text-decoration: none; ">
                @if (session()->get('language') == 'bangla')
                    <h1>ব্র্যান্ড</h1>
                @else
                    <h1>Brand</h1>
            ...
            @foreach ($product as $product)
                ...
                <div class="card m-1" style=" position: initial;max-width: 250px;">
                    <div class="card-body">
                        ...
                        <button class="btn btn-danger cart_button" id="{{ $product->id }}" data-bs-toggle="modal"
                            data-bs-target="#pdoductDetailModal" onclick="show_product_detail(this.id)"><i
