    ...
    <section class="sidebar">
                ...
                <a href="{{ url('admin/dashboard') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        @if (@$admin_image->logo == '' || @$admin_image->logo == null)
                            <img loading="lazy" src="{{ asset('upload/no_image.jpg') }}" style="height: 40px; width:150px;"
                                alt="No Image">
                        @else
                            <img loading="lazy" src="{{ asset('storage/logo/' . @$admin_image->logo) }}"
        ...
        <ul class="sidebar-menu" data-widget="tree" style="background-color: #98EECC">
            ...
            <li class="treeview {{ $prefix == '/brand' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/external-brand-public-relations-agency-flaticons-lineal-color-flat-icons.png"
                        alt="external-brand-public-relations-agency-flaticons-lineal-color-flat-icons" />
            ...
            <li class="treeview {{ $prefix == '/category' ? 'active' : '' }}">
                <a href="">
                    <img loading="lazy" width="20" height="20" src="https://img.icons8.com/dusk/64/diversity.png"
                        alt="diversity" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'all.category' ? 'active' : '' }}"><a href="{{ route('all.category') }}"><i
                                class="ti-more"></i>All Cetegory</a></li>
                    <li class="{{ $route == 'all.subcategory' ? 'active' : '' }}"><a
                            href="{{ route('all.subcategory') }}"><i class="ti-more"></i>All SubCetegory</a></li>
                    <li class="{{ $route == 'all.subsubcategory' ? 'active' : '' }}"><a
                            href="{{ route('all.subsubcategory') }}"><i class="ti-more"></i>All Sub->SubCetegory</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/author' ? 'active' : '' }}">
                <a href="">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/emoji/48/open-book-emoji.png" alt="open-book-emoji" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'add.author' ? 'active' : '' }}"><a href="{{ route('add.author') }}"><i
                                class="ti-more"></i>Author Add</a></li>
                    <li class="{{ $route == 'all.author' ? 'active' : '' }}"><a href="{{ route('all.author') }}"><i
                                class="ti-more"></i>All Author List</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/product' ? 'active' : '' }}">
                <a href="">
                    <img loading="lazy" width="20" height="20" src="https://img.icons8.com/nolan/64/product.png"
                        alt="product" />
            ...
            <li class="treeview {{ $prefix == '/stock' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/color/48/business-report.png" alt="business-report" />
            ...
            <li class="treeview {{ $prefix == '/coupons' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/external-wanicon-flat-wanicon/64/external-coupon-cyber-monday-wanicon-flat-wanicon.png"
                        alt="external-coupon-cyber-monday-wanicon-flat-wanicon" />
            ...
            <li class="treeview {{ $prefix == '/slider' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/water-color/50/sorting-options.png" alt="sorting-options" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'manage-slider' ? 'active' : '' }}"><a
                            href="{{ route('manage-slider') }}"><i class="ti-more"></i>Home Slider</a></li>
                    <li class="{{ $route == 'manage.category-slider' ? 'active' : '' }}"><a
                            href="{{ route('manage.category-slider') }}"><i class="ti-more"></i>Category Slider</a>
                    </li>
                    <li class="{{ $route == 'manage.top-sidebar-menu-slider' ? 'active' : '' }}"><a
                            href="{{ route('manage.top-sidebar-menu-slider') }}"><i class="ti-more"></i>Top-Sidebar
                            Menu Slider</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/alluser' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20" src="https://img.icons8.com/neon/96/user.png"
                        alt="user" />
            ...
            <li class="treeview {{ $prefix == '/orders' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/external-itim2101-blue-itim2101/64/external-delivery-box-shopping-and-ecommerce-itim2101-blue-itim2101.png"
                        alt="external-delivery-box-shopping-and-ecommerce-itim2101-blue-itim2101" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'prnding-orders' ? 'active' : '' }}"><a
                            href="{{ route('prnding-orders') }}"><i class="ti-more"></i>Pending Orders</a></li>
            ...
            <li class="treeview {{ $prefix == '/return' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/nolan/64/return.png" alt="return" />
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'all.request.approve' ? 'active' : '' }}"><a
                            href="{{ route('all.request.approve') }}"><i class="ti-more"></i>All Request Approve</a>
                    </li>
                    <li class="{{ $route == 'all.request.cancel' ? 'active' : '' }}"><a
                            href="{{ route('all.request.cancel') }}"><i class="ti-more"></i>All Request Cancel</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/shipping' ? 'active' : '' }}">
                <a href="#">
                    {{-- <i data-feather="file"></i> --}}
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/color/48/in-transit--v1.png" alt="in-transit--v1" />
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'manage-upazila' ? 'active' : '' }}"><a
                            href="{{ route('manage-upazila') }}"><i class="ti-more"></i>Ship Upazila</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/product_units' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20" src="https://img.icons8.com/color/48/blog.png"
                        alt="blog" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'all.product_units' ? 'active' : '' }}"><a
                            href="{{ route('all.product_units') }}"><i class="ti-more"></i>Manage Units</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/sidebar' ? 'active' : '' }}">
                <a href="#">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/dotty/80/sidebar-menu.png" alt="sidebar-menu" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'top_sidebar.view' ? 'active' : '' }}"><a
                            href="{{ route('top_sidebar.view') }}"><i class="ti-more"></i>Top Sidebar Menu List</a>
                    </li>
                    <li class="{{ $route == 'top_sidebar.add' ? 'active' : '' }}"><a
                            href="{{ route('top_sidebar.add') }}"><i class="ti-more"></i>Top Sidebar Menu Add</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/book_type' ? 'active' : '' }}">
                <a href="">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/emoji/48/books-emoji.png" alt="books-emoji" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'all.book-type' ? 'active' : '' }}"><a
                            href="{{ route('all.book-type') }}"><i class="ti-more"></i>All Book-Type</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/publication' ? 'active' : '' }}">
                <a href="">
                    <img loading="lazy" width="20" height="20"
                        src="https://img.icons8.com/color-glass/48/publication.png" alt="publication" />
                ...
                <ul class="treeview-menu">
                    <li class="{{ $route == 'all.publication' ? 'active' : '' }}"><a
                            href="{{ route('all.publication') }}"><i class="ti-more"></i>All Publication</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ $prefix == '/setting' ? 'active' : '' }}" onclick="scroll(0, 1000);">
                <a href="#">
                    {{-- <i data-feather="file"></i> --}}
                    <img loading="lazy" width="20" height="20" src="https://img.icons8.com/nolan/64/gear.png"
                        alt="gear" />
