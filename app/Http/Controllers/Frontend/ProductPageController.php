...
class ProductPageController extends Controller
{
    ...
    public function ShowProductCategoryPage($mainCategory_id, $mainCategory_name)
    {
        ...
        $data['product']  = Product::where('category_id',$mainCategory_id)->where('status',1)->where('product_qty','>','0')->get();
    ...
    public function ShowProductAuthorPage($author_id, $author_name)
    {
        ...
        $data['product']  = Product::where('author_id',$author_id)->where('status',1)->where('product_qty','>','0')->get();
        $sub_category  = SubCategory::orderBy('id', 'asc')->get();
        foreach($data['main_category'] as $item){
            $data['sub_category'][$item->id] = SubCategory::orderBy('id', 'asc')->where('category_id', $item->id)->get();
        }
    ...
    public function ShowProductSideBarTopMenuPage( $mainCategory_id, $mainCategory_name){
        ...
        $data['product']  = Product::where('sid_sps_section', $mainCategory_name)->where('status',1)->where('product_qty','>','0')->get();
        $catID= array();
        foreach($data['product'] as $item ){
            array_push($catID , $item->category_id);
        }
        $new_array=array_unique($catID); 
        $data['main_category']  = Category::whereIn('id', $new_array )->orderBy('id', 'asc')->get();
    ...
    public function GroceryProduct()
    {
        ...
        $data['product']  = Product::where('brand_id', 1)->where('status',1)->where('product_qty','>','0')->get();
    ...
    public function ShowProductSubCategoryPage($mainCategory_id, $mainCategory_name){
        ...
        $data['product']  = Product::where('subcategory_id',$mainCategory_id)->where('status',1)->where('product_qty','>','0')->get();
    ...
    public function ShowProductSubSubCategoryPage($mainCategory_id, $mainCategory_name){
        ...
        $data['product']  = Product::where('subsubcategory_id',$mainCategory_id)->where('status',1)->where('product_qty','>','0')->get();
    ...
    public function ShowSingleBrandPage($brand_id){
        $data['carts'] = Cart::content();
        $data['product'] = Product::where('brand_id', $brand_id)->where('status', 1)->where('product_qty','>','0')->get();
    ...
    {
        $products = Product::latest()->select('product_name_en','product_name_bn')->where('status',1)->where('product_qty','>','0')->get();
        $array = array();
