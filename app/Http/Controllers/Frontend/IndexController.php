...
class IndexController extends Controller
{
    ...
    public function ShowSlider(){
        $slider= Slider::orderBy('id', 'asc')->where('status',1)->get();
        return response()->json(array(
            'sliders' => $slider,
        ));
    }
    public function ShowCategorySlider($main_category){
        $slider= CategorySlider::orderBy('id', 'asc')->where('category_id',$main_category)->where('status',1)->get();
        return response()->json(array(
            'sliders' => $slider,
        ));
    }
    public function ShowSubCategorySlider($main_category){
        $slider= CategorySlider::orderBy('id', 'asc')->where('subcategory_id',$main_category)->get();
        return response()->json(array(
            'sliders' => $slider,
        ));
    }
    public function ShowSubSubCategorySlider($main_category){
        $slider= CategorySlider::orderBy('id', 'asc')->where('subsubcategory_id',$main_category)->get();
        return response()->json(array(
            'sliders' => $slider,
        ));
    }
    public function ShowTop_sidebar_menu_sliderSlider($main_category){
        $slider= TopSidebarMenuSlider::orderBy('id', 'asc')->where('top_sidebar_id',$main_category)->where('status',1)->get();
        return response()->json(array(
            'sliders' => $slider,
        ));
    }
